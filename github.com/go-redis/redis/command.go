...
func (cmd *Cmd) String() (string, error) {
	...
	case string:
		return val, nil
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for String", val)
		return "", err
	}
}
...
func (cmd *Cmd) Int() (int, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Int", val)
		return 0, err
	}
}
...
func (cmd *Cmd) Int64() (int64, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Int64", val)
		return 0, err
	}
}
...
func (cmd *Cmd) Uint64() (uint64, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Uint64", val)
		return 0, err
	}
}
...
func (cmd *Cmd) Float32() (float32, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Float32", val)
		return 0, err
	}
}
...
func (cmd *Cmd) Float64() (float64, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Float64", val)
		return 0, err
	}
}
...
func (cmd *Cmd) Bool() (bool, error) {
	...
	default:
		err := fmt.Errorf("redis-set: unexpected type=%T for Bool", val)
		return false, err
	}
}
...
func clusterSlotsParser(rd *proto.Reader, n int64) (interface{}, error) {
	...
	for i := 0; i < len(slots); i++ {
		...
		if n < 2 {
			err := fmt.Errorf("redis-set: got %d elements in cluster info, expected at least 2", n)
			return nil, err
		}
...
func commandInfoParser(rd *proto.Reader, n int64) (interface{}, error) {
	...
	if n != 6 {
		return nil, fmt.Errorf("redis-set: got %d elements in COMMAND reply, wanted 6", n)
	}
