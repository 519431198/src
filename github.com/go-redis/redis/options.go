...
func ParseURL(redisURL string) (*Options, error) {
	...
	if u.Scheme != "redis-set" && u.Scheme != "rediss" {
		return nil, errors.New("invalid redis-set URL scheme: " + u.Scheme)
	}
	...
	case 1:
		if o.DB, err = strconv.Atoi(f[0]); err != nil {
			return nil, fmt.Errorf("invalid redis-set database number: %q", f[0])
		}
	default:
		return nil, errors.New("invalid redis-set URL path: " + u.Path)
	}
